				...
				<div class="col-lg-4 mx-auto">
					<form action="resources/php/lookforbook_db.php" method="POST">
						...
						<div class="form-group">
							...
							<input type="number" class="form-control" name="form-edition" id="form-edition" value="0">
						</div>
						
						<!--<div class="form-group">
							<label for="form-category">Category</label>
							<input type="text" class="form-control" name="form-category" id="form-category">
						</div>
						<div class="form-group">
							<label for="form-general-category">Category</label>
							<select class="form-control"  name="form-general-category" id="form-general-category" 'selected="selected"'>
